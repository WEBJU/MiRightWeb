...
<footer class="container mx-auto  bg-white pt-20 lg:pt-[120px] pb-10 lg:pb-20 relative z-10 border-t-1" >
   <div class="container">
      <div class="flex flex-wrap -mx-4" >
         <div class="w-full sm:w-2/3 lg:w-3/12 px-4">
            <div class="w-full mb-10">
               ...
               <p class="flex items-center text-sm text-dark font-medium">
                  ...
                  <span>(+254) 112226517</span>
               </p>
            </div>
         </div>
         <div class="w-full sm:w-1/2 lg:w-2/12 px-4">
            <div class="w-full mb-10">
               <h4 class="text-lg font-semibold mb-9" style="color:#d36569">Resources</h4>
               <ul>
                  <li>
                     <a
                        href="javascript:void(0)"
         ...
         <div class="w-full sm:w-1/2 lg:w-2/12 px-4">
            <div class="w-full mb-10">
               <h4 class="text-lg font-semibold mb-9" style="color:#d36569">Company</h4>
               <ul>
                  <li>
                     <a
                        href="javascript:void(0)"
         ...
         <div class="w-full sm:w-1/2 lg:w-2/12 px-4">
            <div class="w-full mb-10">
               <h4 class="text-lg font-semibold mb-9" style="color:#d36569">Quick Links</h4>
               <ul>
                  <li>
                     <a
                        href="javascript:void(0)"
         ...
         <div class="w-full sm:w-1/2 lg:w-3/12 px-4">
            <div class="w-full mb-10">
               <h4 class="text-lg font-semibold mb-9" style="color:#d36569">Follow Us On</h4>
               ...
               <p class="text-base text-body-color">&copy; {{date('Y')}} MiRight</p>
            </div>
         </div>
      </div>
   </div>
